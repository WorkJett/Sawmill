...
foreign import subscribe :: forall eff a. State a -> (a -> Eff (st :: St | eff) Unit) -> Eff (st :: St | eff) (State a)
foreign import behavior :: forall eff a. State a -> (a -> Eff (st :: St | eff) Unit) -> Eff (st :: St | eff) (State a)
foreign import unsubscribe :: forall eff a. State a -> (a -> Eff (st :: St | eff) Unit) -> Eff (st :: St | eff) (State a)
